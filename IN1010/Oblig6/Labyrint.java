...
public class Labyrint {
	...
	private Lock laas2 = new ReentrantLock();
	private Condition ferdig = laas2.newCondition();
	...
	public SortertLenkeliste<String> finnUtveiFra(int kol, int rad) throws InterruptedException {
